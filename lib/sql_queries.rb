...
"SELECT users.name, sum(pledges.amount) AS total_pledges FROM Users JOIN Pledges ON users.id = pledges.user_id GROUP BY users.id ORDER BY total_pledges, users.name"
end
